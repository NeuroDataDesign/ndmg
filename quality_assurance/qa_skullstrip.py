...
def plot_overlays(origional, b0, cmaps=None, minthr=2, maxthr=95, edge=False):
    ...
    origional = mgu.gen_utils.get_braindata(origional)
...
brain = file_path1 = r'/mnt/f/JHU/ndd/dataset/part_of_SWU4/sub-0025629_ses-1_T1w.nii.gz'
origional = file_path2 = r'/mnt/c/Users/luochuankai/Desktop/trash/skulled/sub-0025629_ses-1_T1w_noskull.nii.gz'
outdir = save_path = r'/mnt/f/JHU/ndd/dataset/output1/sub-0025864/ses-1/'
reg_brain_pngs(brain, origional, outdir, loc=0, mean=False, minthr=2, maxthr=95, edge=False)